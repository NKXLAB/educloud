...
```
  ...
  $ sudo useradd -d /opt/educloud -M -r -g educloud educloud
  $ chown -R educloud:educloud /opt/educloud
  $ sudo mount 10.32.143.228:/opt/educloud/cloudserver/storagedir /opt/educloud/cloudnode/storagedir
  $ sudo mount 10.32.143.228:/opt/educloud/cloudserver/templatedir /opt/educloud/cloudnode/templatedir
```
