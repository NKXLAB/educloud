...
(
    ...
    FOREIGN KEY(USER_ID) REFERENCES PUBLIC.CLOUD_USER(USER_ID)
);
...
INSERT INTO TEMPLATE (TEMPLATE_ID, OS_TYPE, NAME, FILENAME) 
     VALUES ((VALUES NEXT VALUE FOR SEQ_TEMPLATE_ID), 'Ubuntu', 'Ubuntu minimal config', 'ubuntu-light.vdi');
     
-- create default virtual machine for admin
INSERT INTO MACHINE (MACHINE_ID, TEMPLATE_ID, USER_ID, NAME, STATE) 
     VALUES ((VALUES NEXT VALUE FOR SEQ_MACHINE_ID), 1, 1, 'Virtual machine of admin', 'DONE');
     
-- create default virtual machine for guest
INSERT INTO MACHINE (MACHINE_ID, TEMPLATE_ID, USER_ID, NAME, STATE) 
     VALUES ((VALUES NEXT VALUE FOR SEQ_MACHINE_ID), 1, 2, 'Virtual machine of guest', 'DONE');