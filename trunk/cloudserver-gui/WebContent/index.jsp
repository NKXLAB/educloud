...
<jsp:useBean id="cloudBean" scope="session" class="com.google.educloud.gui.beans.CloudAPIBean" />
	<html>
	<head>
	...
	<%
		EduCloudTemplateClient templateClient = cloudBean.getTemplateClient();
